...
selected `math.*` functions, expression-body user-defined functions, named
colors, `color.new`, tuple returns, incremental append execution, realtime
forming-bar rollback, Python bindings, and a thin WASM binding.
