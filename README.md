...
functions, named colors, color helpers, tuple returns, global scalar `varip`,
...
element types, recursive functions, function side effects, local/non-scalar
`varip` forms, and `varip` arrays or drawing ids.
