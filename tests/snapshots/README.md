...
At this stage the live gate discovers 718 registered CLI snapshots and verifies
420 manifest-required snapshots in both hosts. Registered snapshots must either
