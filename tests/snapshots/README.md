...
At this stage the live gate discovers 717 registered CLI snapshots and verifies
419 manifest-required snapshots in both hosts. Registered snapshots must either
