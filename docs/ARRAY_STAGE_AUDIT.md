...
- Remaining array history behavior still needs design for non-label object
  arrays, slice history, and broader mutation/aliasing semantics.
...
- Design remaining array history aliasing behavior, including non-label object
  arrays, slice snapshots, and mutation of historical copies.
