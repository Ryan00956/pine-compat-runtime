...
- Added fixture-backed UDT passthrough through UDF parameters and return values.
  ...
  the callsite, and field-read there; field mutation, UDF construction from
  untyped scalar parameters, imported UDT identity, UDT history, `varip`, nested
  UDT fields, and UDT arrays remain outside the supported subset.
