...
- Add realtime rollback and limit fixtures for the now-supported
...
- General polyline arrays and broader rollback/limit coverage until each
  behavior is fixture-backed.
