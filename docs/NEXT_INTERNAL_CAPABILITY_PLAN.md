...
- Remaining linefill collection support beyond `linefill.new`,
  `linefill.set_color`, `linefill.get_line1`, and `linefill.get_line2`,
  including `linefill.all` and linefill arrays.
