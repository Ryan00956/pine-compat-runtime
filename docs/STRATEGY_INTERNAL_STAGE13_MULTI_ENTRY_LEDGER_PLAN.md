...
- Python public JSON parity coverage for the same omitted `loss+profit` bracket
  persistent fixture;
- duplicate same-id omitted-`from_entry` relative targets;
- price-based same-tick pyramiding-limit exceptions;
- broader host parity coverage for future public JSON contracts.
...
`loss+profit` bracket persistent fixture. It must not be used to claim duplicate
