...
omitted-`from_entry` current unique-entry-id profit-tick all-entry exit. It must
not be used to claim omitted-`from_entry` loss/bracket/trailing all-entry exits,
