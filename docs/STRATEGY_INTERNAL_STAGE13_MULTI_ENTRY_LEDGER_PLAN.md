...
unique-entry-id loss-tick future-entry persistence. It must not be used to claim
omitted-`from_entry` bracket or trailing relative future-entry persistence,
