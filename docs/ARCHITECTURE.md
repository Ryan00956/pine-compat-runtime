...
`table.new` may initialize the final background color, frame color, and frame
width through its optional `bgcolor`, `frame_color`, and `frame_width`
arguments, while border initializers remain unsupported;
