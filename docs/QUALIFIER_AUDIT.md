...
- Scalar array, scalar slice, label-array, line-array, linefill-array,
  box-array, and table-array ids can now receive series storage for
  fixture-backed array history snapshots. Polyline arrays, non-scalar slice
  history, map/matrix values, and broader aliasing rules remain undesigned.
