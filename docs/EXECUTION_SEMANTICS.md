...
share the fourteen matrix helpers and the copy/row/column/eigenvalue/predicate-
...
a concrete supported matrix kind now share the fourteen matrix helpers through
...
and `.is_symmetric()`. Exact namespace
`matrix.copy(values)`
also enters this
