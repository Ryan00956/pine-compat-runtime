...
share the twenty-four matrix helpers and the copy/row/column/eigenvalue/
...
a concrete supported matrix kind now share the twenty-four matrix helpers through
