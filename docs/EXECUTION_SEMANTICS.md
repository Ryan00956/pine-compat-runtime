...
linefill-array, linefill-slice, box-array, and table-array read paths, including the official
...
non-label/line/box/linefill object slice history, and richer mutation/aliasing cases, remain outside
