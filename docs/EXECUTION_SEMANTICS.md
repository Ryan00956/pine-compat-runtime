...
`table.set_bgcolor`/`table.set_frame_color`, plus
...
table's final frame-color value; visual anchoring, frame width, and layout
remain host responsibilities. `table.cell_set_text`
