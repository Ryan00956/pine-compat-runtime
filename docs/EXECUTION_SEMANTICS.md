...
scalar slice, label-array, line-array, linefill-array, and box-array read paths, including the official
...
array id. Broader array-history edges, including remaining object arrays and
non-scalar slice history, remain outside the current contract.
