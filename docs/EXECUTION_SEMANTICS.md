...
share the ten matrix helpers and the copy/row/column/eigenvalue/predicate-reader continuation rules for matrix or
...
a concrete supported matrix kind now share the ten matrix helpers through
