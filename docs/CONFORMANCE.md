...
key/value metadata and copy independence. Local user-method results retaining
...
scalar-template-interleaving, and independent-copy paths. Unknown/`na`,
...
local user-method results with the same concrete template use a source-marked
call-result path across receiver-style, local-type-qualified, and direct
constructor receivers. Imported user-method/imported-function, unresolved or
mixed-template results, and wrong-result helpers remain outside that path.
