...
terminal `.is_square()`. Int inputs still produce
...
is terminal. Other terminal readers, invalid
...
matrix kind through `SameAsArg`, and admit the same fifteen matrix helpers subject
