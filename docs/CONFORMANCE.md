...
historical and forming-bar rollback lifecycle subset. Typed declarations,
drawing point overloads, general polyline arrays, and richer limit parity remain
outside the supported subset; see `docs/PHASE_E_POLYLINE_GATE.md`.
