...
element types. Bare `array`, `array<polyline>`/`polyline[]`, UDT, map, matrix,
and other typed declarations remain unsupported unless a narrower feature row
