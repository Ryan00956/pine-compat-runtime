...
field arguments. The receiver is passed as the first internal parameter.
Returned receiver values, local UDT parameter values, or constructed local UDT
values may be assigned and field-read at the callsite. Side effects, recursion,
