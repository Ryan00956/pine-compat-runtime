...
historical lifecycle subset. Typed declarations, drawing point overloads,
realtime rollback fixtures, and general polyline arrays remain outside the
supported subset; see `docs/PHASE_E_POLYLINE_GATE.md`.
