...
`from_entry` `stop+profit` bracket exits; same-id omitted `loss+limit`,
`stop+limit`, trailing, and future-entry persistence remain outside this
claim.
