...
array.*              partial      float/int/bool/string/color creation, reference, copy, slice/concat, search, numeric statistics, ordering, join, mutation, and helper fixture subset only
