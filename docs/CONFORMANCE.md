...
`trail_points+trail_offset` trailing subset. Stage 13 Slices 29-33 add
fixture-backed omitted-`from_entry` unique-entry-id future-entry persistence for
profit-tick, loss-tick, `loss+profit`, `stop+profit`, and `loss+limit` exits.
