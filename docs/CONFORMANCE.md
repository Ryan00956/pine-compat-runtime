...
active `margin_long` is configured. They do not enable short margin behavior,
margin-specific equity-snapshot expansion, margin liquidation price, or forced
liquidation. Stage 7 Slice 17 accepts
