...
creation past the fixed 100-polyline runtime limit. Typed declarations, drawing
point overloads, general polyline arrays, and declaration-driven
max-count/eviction parity remain outside the supported subset; see
