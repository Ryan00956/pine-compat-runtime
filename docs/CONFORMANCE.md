...
same physical library isolated. Mixed imported identities, non-scalar imported
array returns, tuple-contained UDT arrays, direct call-result array method
chaining, and mutation through unsupported UDF/method side-effect contexts
