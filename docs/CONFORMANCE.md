...
with sparse snapshots and a 500-box runtime limit. The executable table subset covers
...
and shares the box runtime limit. Supported drawing creation, mutation,
