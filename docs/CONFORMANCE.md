...
polyline creation snapshots are exposed under `polylines`; analysis and matrix
JSON remain `schemaVersion: 2`.
...
runtime snapshots. Typed declarations, drawing point overloads, and broader
polyline lifecycle APIs remain outside the supported subset; see
