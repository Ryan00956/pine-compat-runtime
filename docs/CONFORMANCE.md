...
bound `matrix_id.mult(...)`, `matrix_id.submatrix()`/`matrix_id.kron(...)`/
...
storage; other bound or UDF matrix-result receivers do not enter this path.
