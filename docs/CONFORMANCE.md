...
key/value metadata and copy independence. Unknown/`na`, scalar, array, matrix,
...
qualified user-method/imported-function, unresolved or mixed-template results,
and wrong-result helpers remain outside that path.
