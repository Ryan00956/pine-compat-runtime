...
horizontal-alignment/vertical-alignment mutators, `box.delete`, and
...
records vertical text alignment in box snapshots; text wrap, font, and richer
layout methods remain unsupported. `box.get_left`, `box.get_right`,
