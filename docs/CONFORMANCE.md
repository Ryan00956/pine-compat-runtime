...
Conflicting identities within one scalar return or tuple slot, non-scalar imported array returns,
direct call-result array method chaining, and mutation through unsupported
UDF/method side-effect contexts remain outside the supported matrix.
