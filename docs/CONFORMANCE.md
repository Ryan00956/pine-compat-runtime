...
Typed declarations, drawing point overloads, and `polyline.*` remain outside
...
chart.point          partial      chart.point.new/now/from_index/from_time/copy constructors, time/index/price field reads, top-level field mutation, and array.new<chart.point>/array.from chart-point array storage/read/mutation/search are fixture-backed; typed declarations, drawing point overloads, and polyline construction remain unsupported
