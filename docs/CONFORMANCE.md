...
array.*              partial      float/int/bool/string/color creation and from inference, reference, copy, insert/remove, fill, slice/concat, search, numeric statistics, ordering, join, mutation, and helper fixture subset only
