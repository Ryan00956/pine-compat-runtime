...
strategy.exit       unsupported  semantic staging accepts stop-only calls with runtime placeholder diagnostics; executable pending exits and fills remain unimplemented
