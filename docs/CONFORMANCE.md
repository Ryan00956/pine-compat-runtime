...
short limit timing model while also bypassing that limit, opens or increases
short exposure while flat or already short, and is a no-op while net long.
...
short, and is a no-op while net long. Reduce-only market
...
exposed under `strategy.alerts`. Market `strategy.short` entries are
...
flat or already short. Short limit, stop, and stop-limit `strategy.order` fills
are fixture-backed while flat or already short.
...
long-market/price-based, reduce-only market-short, and short
limit/stop/stop-limit add-or-increase subset, realtime strategy
