...
`strategy.exit` matching by requested open pyramided long entry id; broader
multi-entry `strategy.exit` semantics remain outside this claim. Stage 7 Slice
17 accepts
