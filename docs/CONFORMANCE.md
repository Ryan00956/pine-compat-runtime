...
`table`, and `polyline` declarations are fixture-backed with compatible or
`na` initializers and later compatible reassignment. Array, UDT, map, matrix,
...
typed declarations   partial      int, float, bool, string, color, chart.point, and drawing-id label/line/linefill/box/table/polyline typed variable declarations with compatible or na initializers and later compatible reassignment are fixture-backed; array, UDT, map, matrix, and other typed declarations remain unsupported unless covered by narrower feature rows
