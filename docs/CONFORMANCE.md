...
`from_entry` profit-tick exits, using each open trade's entry price; same-id
omitted loss, bracket, trailing, and future-entry persistence remain outside
this claim.
