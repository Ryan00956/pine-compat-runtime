...
array.*              partial      float/int/bool/string/color creation and from inference, reference, copy, insert/remove, fill, slice/concat, search/binary search, numeric abs/statistics/range/median/mode/percentile/standardize/variance/stdev, ordering, join, mutation, and helper fixture subset only
