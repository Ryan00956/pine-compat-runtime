...
fixture-backed. Stage 13 Slice 75 adds fixture-backed same-tick limit-entry
pyramiding-limit exceptions only; same-tick stop and stop-limit entry
exceptions remain outside this claim. Stage 13 Slice 11 adds fixture-backed
`strategy.close(id)`
