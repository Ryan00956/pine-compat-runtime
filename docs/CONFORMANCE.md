...
copy paths. Remaining user-function matrix results do not enter these paths.
...
user-function and unresolved/non-matrix method results,
...
Unknown/`na`, scalar, array, map, remaining user-function matrix results,
