...
mutators, `box.delete`, and fixture-backed cloning with `box.copy` over the latest existing box
...
`box.set_text_size` records text size in box snapshots; text alignment, wrap,
