...
`D`, `E`, `h`, `m`, `s`, `S`, `a`, `Z`, and single-quoted literals. `D`
renders the day of the year with optional zero-padding, and `E` renders short
or full weekday names. IANA and exchange timezone conversion remain
unsupported.
