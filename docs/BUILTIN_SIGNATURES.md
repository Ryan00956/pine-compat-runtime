...
time(timeframe: simple string, bars_back?: simple int) -> series int
time_close(timeframe: simple string, bars_back?: simple int) -> series int
```
...
errors.
`time(timeframe, bars_back)` and `time_close(timeframe, bars_back)` currently
implement the simple-string timeframe subset with an optional simple-int
`bars_back`. `""` and `timeframe.period` use the current fixed chart timeframe
and return the current bar's existing `time` or `time_close` value when
`bars_back` is omitted or 0. For nonzero `bars_back`, the runtime offsets from
the current bar using the fixed 1-minute chart timeframe before mapping to the
requested UTC timeframe bucket. Higher timeframe strings in the supported
timeframe subset return UTC bucket opening or closing timestamps. Negative
`bars_back` values can reference at most 500 future chart bars. Time-based
session strings, timezone overrides, and `timeframe_bars_back` remain
unsupported.
...
array.size(id: float-array|int-array|bool-array|string-array|color-array|label-array|line-array|box-array|table-array) -> simple int
array.push(id: float-array|int-array|bool-array|string-array|color-array|label-array|line-array|box-array|table-array, value: element-compatible) -> void
array.get(id: float-array|int-array|bool-array|string-array|color-array|label-array|line-array|box-array|table-array, index: simple int) -> series element
array.set(id: float-array|int-array|bool-array|string-array|color-array|label-array|line-array|box-array|table-array, index: simple int, value: element-compatible) -> void
array.insert(id: float-array|int-array|bool-array|string-array|color-array|label-array|line-array|box-array|table-array, index: simple int, value: element-compatible) -> void
array.pop(id: float-array|int-array|bool-array|string-array|color-array|label-array|line-array|box-array|table-array) -> series element
array.remove(id: float-array|int-array|bool-array|string-array|color-array|label-array|line-array|box-array|table-array, index: simple int) -> series element
array.shift(id: float-array|int-array|bool-array|string-array|color-array|label-array|line-array|box-array|table-array) -> series element
array.unshift(id: float-array|int-array|bool-array|string-array|color-array|label-array|line-array|box-array|table-array, value: element-compatible) -> void
array.fill(id: float-array|int-array|bool-array|string-array|color-array|label-array|line-array|box-array|table-array, value: element-compatible, index_from?: simple int, index_to?: simple int) -> void
array.first(id: float-array|int-array|bool-array|string-array|color-array|label-array|line-array|box-array|table-array) -> series element
array.last(id: float-array|int-array|bool-array|string-array|color-array|label-array|line-array|box-array|table-array) -> series element
array.copy(id: float-array|int-array|bool-array|string-array|color-array|label-array|line-array|box-array|table-array) -> same array kind
array.slice(id: float-array|int-array|bool-array|string-array|color-array|label-array|line-array|box-array|table-array, index_from: simple int, index_to: simple int) -> same array kind
array.concat(id: float-array|int-array|bool-array|string-array|color-array|label-array|line-array|box-array|table-array, id2: same array kind) -> same array kind
array.includes(id: float-array|int-array|bool-array|string-array|color-array|label-array|line-array|box-array|table-array, value: element-compatible) -> series bool
array.every(id: float-array|int-array|bool-array) -> series bool
array.some(id: float-array|int-array|bool-array) -> series bool
array.indexof(id: float-array|int-array|bool-array|string-array|color-array|label-array|line-array|box-array|table-array, value: element-compatible) -> simple int
array.lastindexof(id: float-array|int-array|bool-array|string-array|color-array|label-array|line-array|box-array|table-array, value: element-compatible) -> simple int
...
array.reverse(id: float-array|int-array|bool-array|string-array|color-array|label-array|line-array|box-array|table-array) -> void
array.join(id: float-array|int-array|bool-array|string-array|color-array, separator?: string-compatible) -> series string
array.clear(id: float-array|int-array|bool-array|string-array|color-array|label-array|line-array|box-array|table-array) -> void
```
...
scalar typed arrays; linefill and polyline arrays remain
unsupported.
...
emits one literal apostrophe. Missing placeholder indexes remain literal text.
Unmatched braces are runtime errors. Non-numeric format modifiers outside the
fixture-covered subset are not yet claimed.
