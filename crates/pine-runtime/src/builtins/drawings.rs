...
impl<'a> HistoricalRuntime<'a> {
    ...
    fn eval_table_new(&mut self, args: &[HirCallArg]) -> Result<PineValue, RuntimeError> {
    ...
    fn eval_line_set_x1(&mut self, args: &[HirCallArg]) -> Result<PineValue, RuntimeError> {
    ...
    fn eval_line_set_y1(&mut self, args: &[HirCallArg]) -> Result<PineValue, RuntimeError> {
        let id = self.eval_line_id_arg(args)?;
    ...
    fn eval_line_set_xy1(&mut self, args: &[HirCallArg]) -> Result<PineValue, RuntimeError> {
        let id = self.eval_line_id_arg(args)?;
        let x = self.eval_required_line_arg(args, 1, "x")?;
    ...
    fn eval_line_set_x2(&mut self, args: &[HirCallArg]) -> Result<PineValue, RuntimeError> {
        let id = self.eval_line_id_arg(args)?;
        let x = self.eval_required_line_arg(args, 1, "x")?;
        self.mutate_line(id, |snapshot| {
            snapshot.x2 = x;
    ...
    fn eval_line_set_y2(&mut self, args: &[HirCallArg]) -> Result<PineValue, RuntimeError> {
        let id = self.eval_line_id_arg(args)?;
        let y = self.eval_required_line_arg(args, 1, "y")?;
        self.mutate_line(id, |snapshot| {
            snapshot.y2 = y;
    ...
    fn eval_line_set_xy2(&mut self, args: &[HirCallArg]) -> Result<PineValue, RuntimeError> {
        let id = self.eval_line_id_arg(args)?;
        let x = self.eval_required_line_arg(args, 1, "x")?;
        let y = self.eval_required_line_arg(args, 2, "y")?;
        self.mutate_line(id, |snapshot| {
    ...
    fn eval_line_set_color(&mut self, args: &[HirCallArg]) -> Result<PineValue, RuntimeError> {
        let id = self.eval_line_id_arg(args)?;
    ...
    fn eval_line_set_width(&mut self, args: &[HirCallArg]) -> Result<PineValue, RuntimeError> {
        let id = self.eval_line_id_arg(args)?;
    ...
    fn eval_line_set_style(&mut self, args: &[HirCallArg]) -> Result<PineValue, RuntimeError> {
        let id = self.eval_line_id_arg(args)?;
    ...
    fn eval_line_set_extend(&mut self, args: &[HirCallArg]) -> Result<PineValue, RuntimeError> {
        let id = self.eval_line_id_arg(args)?;
    ...
    fn eval_line_delete(&mut self, args: &[HirCallArg]) -> Result<PineValue, RuntimeError> {
        let id = self.eval_line_id_arg(args)?;
        let Some(id) = id else {
            return Ok(PineValue::Void);
        };
    ...
    fn eval_table_cell(&mut self, args: &[HirCallArg]) -> Result<PineValue, RuntimeError> {
