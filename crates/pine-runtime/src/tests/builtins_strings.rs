...
plot(replace_first == "he1lo" and replace_second == "hel1o" and replace_missing == "hello" and replace_negative == "hello" and replace_na_occurrence == "he1lo" ? 1 : 0)
...
plot(formatted_array == "Values [1.2, 2.6, NaN]" and formatted_datetime == "2021-01-01T00:00:00+0000" and formatted_quote == "Literal {0} and apostrophe ' X" and na(formatted_na) ? 1 : 0)
