...
plot(trimmed == upper and na(missing_trim) and repeated == "ab-ab" and empty_repeat == "" ? 1 : 0)
...
plot(na(invalid_number) and na(double_decimal_number) and na(bad_exponent_number) and na(nonfinite_exponent_number) and na(missing_number) ? 1 : 0)
