    ...
    fn runtime_fixture_bars_csv(fixture: &str) -> &'static str {
        match fixture {
            ...
            "tests/fixtures/runtime/accdist_edge_cases.pine" => {
                include_str!("../../../tests/fixtures/runtime/accdist_edge_cases_bars.csv")
            }
            "tests/fixtures/runtime/iii_edge_cases.pine" => {
                include_str!("../../../tests/fixtures/runtime/iii_edge_cases_bars.csv")
            }
            "tests/fixtures/runtime/nvi_edge_cases.pine" => {
                include_str!("../../../tests/fixtures/runtime/nvi_edge_cases_bars.csv")
            }
            "tests/fixtures/runtime/pvi_edge_cases.pine" => {
                include_str!("../../../tests/fixtures/runtime/pvi_edge_cases_bars.csv")
            }
            "tests/fixtures/runtime/pvt_edge_cases.pine" => {
                include_str!("../../../tests/fixtures/runtime/pvt_edge_cases_bars.csv")
            }
            "tests/fixtures/runtime/vwap_edge_cases.pine" => {
                include_str!("../../../tests/fixtures/runtime/vwap_edge_cases_bars.csv")
            }
            "tests/fixtures/runtime/wad_edge_cases.pine" => {
                include_str!("../../../tests/fixtures/runtime/wad_edge_cases_bars.csv")
            }
            "tests/fixtures/runtime/wvad_edge_cases.pine" => {
                include_str!("../../../tests/fixtures/runtime/wvad_edge_cases_bars.csv")
            }
