...
fn validate_builtin_map_call_result_fixture_paths(
    ...
    require_fixtures(
        ...
        "fixture-backed exact scalar map.new template, namespace map.copy result, concrete local/imported user-function and user-method map results with size/get/contains/copy/keys/values plus terminal put/clear dispatch, fresh key/value-kind array reads, and retained template/remaining-mutation/terminal-reader boundaries",
    )
}
...
fn validate_user_method_map_call_result_fixture_paths(
    ...
    require_fixtures(
        ...
        "fixture-backed concrete local/imported user-method map-result size/get/contains/copy/keys/values plus terminal put/clear dispatch, fresh key/value-kind array reads, and retained template/remaining-mutation/terminal-reader boundaries",
    )
}
...
fn validate_imported_user_method_map_call_result_fixture_paths(
    ...
    require_fixtures(
        ...
        "fixture-backed imported user-method map-result size/get/contains/copy/keys/values plus terminal put/clear dispatch with fresh key/value-kind arrays, dual-alias isolation, and retained template/remaining-mutation/terminal-reader boundaries",
    )
}
...
fn validate_imported_function_map_call_result_fixture_paths(
    ...
    require_fixtures(
        ...
        "fixture-backed imported pure-function map-result size/get/contains/copy/keys/values plus terminal put/clear dispatch with fresh key/value-kind arrays, dual-alias isolation, and retained template/remaining-mutation/terminal-reader boundaries",
    )
}
