    ...
    fn analyze_user_method_call_with_receiver(
        ...
        let (
            ...
            let tuple_contains_user_type_array = return_type
                ...
                && analyzer.function_body_tuple_contains_user_type_array(&method.body);
            (
                return_type,
                body_user_type,
                body_user_type_array,
        ...
        if tuple_contains_user_type_array {
            self.unsupported(
                ...
                "tuple-contained UDT arrays do not preserve their element identity through user-defined method returns",
                call_span,
            );
        }
