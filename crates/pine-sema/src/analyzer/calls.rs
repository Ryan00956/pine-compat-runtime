...
impl Analyzer {
    ...
    fn is_user_call_result_continuation(&self, receiver: &Expr, method_name: &str) -> bool {
        ...
        match method_name {
            ...
            "inv" | "pinv" | "submatrix" | "transpose" => receiver_is_matrix,
            _ => false,
        }
    }
