...
fn collect_imported_user_type_field_param_keys_with_params(
    analyzer: &Analyzer,
    receiver_path: &str,
    source_expr: &Expr,
    type_name: &str,
...
fn field_param_keys_for_user_type_expr(
    analyzer: &Analyzer,
    param_name: &str,
    expr: &Expr,
    type_name: &str,
...
fn field_param_keys_for_source_path(
    alias_name: &str,
    source_path: &str,
    param_keys: &HashMap<String, String>,
) -> HashMap<String, String> {
