...
mod prelude {
    ...
    pub(crate) use pine_ir::{
        ...
        HirStmt, HirStmtKind, HirSwitchArm, HirSymbol, HirUnaryOp, HirUserTypeIdentity,
        PersistenceKind, PineType, Qualifier, ScriptMode, SymbolId, ValueKind,
    };
    pub(crate) use pine_syntax::{
        BinaryOp, CallArg, DeclaredType, Diagnostic, Expr, ExprKind, FunctionBody, Literal,
        Program, Severity, Span, Stmt, StmtKind, SwitchArm, SwitchArmResult, UnaryOp,
    };

    pub(crate) use crate::analyzer::calls::{
        alias_qualified_method_name, array_method_builtin_name, drawing_method_builtin_name,
        expr_name, is_array_mutation_builtin, is_array_mutation_method_call_name,
        is_map_mutation_builtin, is_map_mutation_method_call_name,
        is_output_or_declaration_builtin, is_ta_vwap_bands_call, map_method_builtin_name,
        method_call_parts, receiver_call_arg,
    };
    pub(crate) use crate::analyzer::context::{
        Analyzer, FunctionInfo, MAX_FUNCTION_CALL_DEPTH, MAX_SEMA_EXPR_DEPTH, MapTypeInfo,
        MethodInfo, MethodParamInfo, MethodResolution, UdfArgError,
    };
    ...
    pub(crate) use crate::analyzer::unsupported::{
        VARIP_DRAWING_UNSUPPORTED_REASON, VARIP_UDT_ARRAY_UNSUPPORTED_REASON,
        VARIP_UDT_UNSUPPORTED_REASON, VARIP_VALUE_UNSUPPORTED_REASON,
        unsupported_collection_reason, unsupported_log_reason, unsupported_strategy_reason,
    ...
    pub(crate) use crate::types::{
        ...
        const_string_value, float_return_for_arg, int_return_for_arg, is_array_kind,
        is_collection_kind, is_numeric, literal_type, matrix_array_return_type,
        matrix_element_return_type, matrix_method_builtin_name, matrix_mult_return_type,
