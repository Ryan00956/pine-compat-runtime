...
fn reports_unsupported_local_udf_matrix_call_result_reads_fixture() {
    ...
    assert_exact_diagnostic_messages(
        ...
        &[
            ...
            "`call_result.rows` is not supported: direct call-result methods require a supported concrete receiver type; bind the result first",
            "`array.rows` is not supported: direct array call-result methods currently support only `.size()`, `.get()`, `.first()`, `.last()`, and `.copy()`; bind the result or use the namespace helper",
            "`map.rows` is not supported: direct map call-result methods currently support only `.size()`, `.get()`, `.contains()`, `.copy()`, and `.keys()`; bind the result or use the namespace helper",
        ],
    );
...
fn reports_unsupported_builtin_map_call_result_reads_fixture() {
    ...
    assert_exact_diagnostic_messages(
        ...
        &[
            ...
            "`map.put` is not supported: direct map call-result methods currently support only `.size()`, `.get()`, `.contains()`, `.copy()`, and `.keys()`; bind the result or use the namespace helper",
            "`map.clear` is not supported: direct map call-result methods currently support only `.size()`, `.get()`, `.contains()`, `.copy()`, and `.keys()`; bind the result or use the namespace helper",
            "`map.remove` is not supported: direct map call-result methods currently support only `.size()`, `.get()`, `.contains()`, `.copy()`, and `.keys()`; bind the result or use the namespace helper",
            "`map.put_all` is not supported: direct map call-result methods currently support only `.size()`, `.get()`, `.contains()`, `.copy()`, and `.keys()`; bind the result or use the namespace helper",
            "`array.push` is not supported: direct array call-result methods currently support only `.size()`, `.get()`, `.first()`, `.last()`, and `.copy()`; bind the result or use the namespace helper",
            "`map.values` is not supported: direct map call-result methods currently support only `.size()`, `.get()`, `.contains()`, `.copy()`, and `.keys()`; bind the result or use the namespace helper",
        ],
    );
