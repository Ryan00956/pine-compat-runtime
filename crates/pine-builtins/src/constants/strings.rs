...
const NAMED_STRING_CONSTANTS: &[NamedStringConstant] = &[
    ...
    same_string_constant("label.style_square"),
    same_string_constant("label.style_diamond"),
    ...
    same_string_constant("label.style_label_center"),
    ...
    same_string_constant("strategy.direction.all"),
    same_string_constant("strategy.direction.long"),
    same_string_constant("strategy.direction.short"),
    same_string_constant("strategy.oca.cancel"),
    same_string_constant("strategy.oca.none"),
    same_string_constant("strategy.oca.reduce"),
